...
sns.barplot(data=df,
            ...
            y='LEABY',
            ax=ax)
ax.set_title("Life Expectancy at Birth in Years by Country")
...
# Visually not that similar outside of being bar charts.
# It is interesting to see that even though the US has a high GDP the life expectancy
# is relatively level compared to 4 of the other 5 countries in the list.
# Makes me think there is not a direct correlation to GDP and life expectancy.
...
# Zimbabwe has had the most chage in the timeframe
# the years with the largest growth were from 2006-2015 in Zimbabwe
# Zimbabwe and Chile both had the least change in GDP
# It doesnt look like there is a direct correlation between GDP and LEABY.
# here are some cases like Germany where they have high LEABY but not the highest GDP
# We could layer in population to somewhat normalize this, it could help 
...
# China
# Zimbabwe
# We saw similar visuals earlier but I think this is abetter way to answer the "Who changed the least/most" questions
# This method is a little easier to read since it doesn't plit them all in the same plane
...
# Uncomment the code below and fill in the blanks
g3 = sns.FacetGrid(df, col="Country", col_wrap=3, height=5)
g3 = (g3.map(plt.plot, "Year", "GDP").add_legend().set(xlim=(2000, 2015),xticks=[2000, 2003, 2006, 2009, 2012, 2015]))
...
# Uncomment the code below and fill in the blanks
g3 = sns.FacetGrid(df, col="Country", col_wrap=3, height=5, hue="Country")
g3 = (g3.map(plt.plot, "Year", "GDP")
      .add_legend()
      .set(xlim=(2000, 2015), 
...
# Highest: USA, China, Germany
# Lowest: Zimbabwe,Chile, Mexico
...
# Highest: Germany, Chile, USA
# Lowest: Zimbabwe, Mexico, China
